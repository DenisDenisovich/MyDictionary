...
public class UseCaseTrainingFirstToSecondImpl implements UseCaseTrainingFirstToSecond {
    ...
    public UseCaseTrainingFirstToSecondImpl(Context context){
                ...
                try {
                    ...
                    if (count >= MIN_COUNT_OF_WORDS) {
                        ...
                        for (int i = 0; i < COUNT_OF_READY_BLOCK; i++) {
                            ...
                            translation = repository.getWordById(id);
