...
import com.dictionary.my.mydictionary.domain.dictionary.impl.UseCaseDictionaryImpl;
...
public class PresenterDictionaryImpl<V extends ViewDictionary> implements PresenterDictionary<V> {
    private V view;
    ...
    public PresenterDictionaryImpl(Context context, Long currentDictionaryId){
