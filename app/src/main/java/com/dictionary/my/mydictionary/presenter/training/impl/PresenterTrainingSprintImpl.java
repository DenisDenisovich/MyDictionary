...
import com.dictionary.my.mydictionary.domain.training.impl.UseCaseTrainingSprintImpl;
...
public class PresenterTrainingSprintImpl<V extends ViewTrainingSprint> implements PresenterTrainingSprint<V> {
    ...
    public PresenterTrainingSprintImpl(Context context){
