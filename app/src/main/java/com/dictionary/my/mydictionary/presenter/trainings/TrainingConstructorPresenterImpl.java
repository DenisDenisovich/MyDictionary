...
import com.dictionary.my.mydictionary.domain.UseCaseTrainingConstructor;
import com.dictionary.my.mydictionary.domain.UseCaseTrainingConstructorImpl;
import com.dictionary.my.mydictionary.domain.entites.WordConstructor;
import com.dictionary.my.mydictionary.view.training.TrainingConstructor;
...
public class TrainingConstructorPresenterImpl<V extends TrainingConstructor> implements TrainingConstructorPresenter<V> {
    V view;
    ...
    public TrainingConstructorPresenterImpl(Context context){
