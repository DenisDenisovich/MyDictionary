...
import com.dictionary.my.mydictionary.presenter.trainings.TrainingSprintPresenter;
import com.dictionary.my.mydictionary.presenter.trainings.TrainingSprintPresenterImpl;

/**
 * Created by luxso on 01.02.2018.
 */

public class TrainingSprintView extends Fragment implements HostToTrainingSprintCommands, TrainingSprint{

    View view;
    TrainingSprintPresenter presenter;
    @Override
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new TrainingSprintPresenterImpl(getActivity().getApplicationContext());
    }
