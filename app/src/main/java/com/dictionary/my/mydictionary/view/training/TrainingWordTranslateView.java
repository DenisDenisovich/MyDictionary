...
public class TrainingWordTranslateView extends Fragment implements TrainingWordTranslate{
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.training_word_translate_fragment,null);
        return view;
