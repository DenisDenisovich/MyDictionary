...
import com.dictionary.my.mydictionary.presenter.training.impl.PresenterTrainingConstructorImpl;
...
public class ViewTrainingConstructorImpl extends Fragment implements ViewTrainingConstructor, HostToTrainingConstructorCommands {
    private PresenterTrainingConstructor presenter;
    View view;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new PresenterTrainingConstructorImpl(getActivity().getApplicationContext());
